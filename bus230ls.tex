...
\abstract{The lesson was designed to help students organize knowledge necessary to select appropriate statistical tests to answer research questions.  Students were then observed as they solved problems in order to better understand thought processes.  Sources of confusion revealed through the lesson study process included difficulty with: identifying when samples were independent vs paired, identifying the scale of measurement, recognizing or defining what constituted the variables in a problem, and distinguishing between statistical language and colloquial language.
}\newline  
